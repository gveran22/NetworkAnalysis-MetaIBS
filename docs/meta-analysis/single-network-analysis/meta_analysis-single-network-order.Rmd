...
meta_layout <- plot_network(total_meta, title = "", thresh = 0, repulsion = 0.6)$layout$layout1
...
ggplot(melted_hub, aes(x = Taxon, y = Study_Method, fill = Presence)) +
  geom_tile(color = "grey90") +
  scale_fill_gradient(low = "white", high = "steelblue") +
  theme_minimal() +
  labs(title = "Hubs Heatmap", x = "Taxon", y = "Study + Method")+
