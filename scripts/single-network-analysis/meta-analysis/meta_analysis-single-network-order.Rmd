...
# for (i in seq_along(matrices.gl)) {
#   meta_adj <- matrix(0, nrow = nrow(meta.gl), ncol = ncol(meta.gl))
#   rownames(meta_adj) <- colnames(meta_adj) <- colnames(meta.gl)
#   sub_adj <- matrices.gl[[i]]
#   meta_adj[rownames(sub_adj), colnames(sub_adj)] <- sub_adj
#   diag(meta_adj) <- 1
#   
#   props_asso.gl <- network_construct(meta_adj)
#   plot(props_asso.gl,
#          layout = layout,
#          nodeColor = "cluster",
#            labelScale = FALSE,
