---
title: "Meta analysis - Single Network Analysis"
output: 
  github_document:
    html_preview: false
date: "2024-03-01"
...
result.gl <- plot_network(meta.gl, title = "Mean Network GLasso", thresh = 0.02, repulsion = 0.4900003)

meta.mb <- summary_assoc_matrix(matrices.mb, "mean")
result.mb <- plot_network(meta.mb, title = "Mean Network MB", thresh = 0.02, repulsion = 0.500001)

meta.slr <- summary_assoc_matrix(matrices.slr, "mean")
result.slr <- plot_network(meta.slr, title = "Mean Network SLR", thresh = 0.02, repulsion = 0.6012)
